...
const imageminPngquant = () => {}; // Try to enable the use of SIMD instructions. Seems to provide a smallish
...
const compressPng = (pipeline, outputPath, options) => pipeline.toBuffer(); // .then((sharpBuffer) =>
//   imagemin
//     .buffer(sharpBuffer, {
//       plugins: [
//         imageminPngquant({
